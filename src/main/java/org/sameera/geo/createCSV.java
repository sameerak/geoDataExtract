...
public class createCSV {
    ...
    public static void main( String[] args )
    {
        ...
        String processedfileName = "/home/sameera/repos/au_geo_data/summary_AUgeo_wekaMin.csv";
        try {
            ...
            sb.append("lat,long,tweetid,userid,screen_name,text,created_at,timestamp");
